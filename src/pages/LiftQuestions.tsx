...
const LiftQuestions = () => {
  ...
  const [questions, setQuestions] = useState<Question[]>([
    { id: "1", text: "How motivated was I before lift today?", enabled: true },
    { id: "2", text: "After my lift, how does my body feel?", enabled: true },
    { id: "3", text: "Am I happy I lifted?", enabled: true },
    { id: "4", text: "Have I stretched for 20 minutes today?", enabled: true },
  ]);
  ...
  const saveQuestions = () => {
    localStorage.setItem("liftQuestions", JSON.stringify(questions));
    toast.success("Lift questions saved!");
  };
        ...
        <div className="w-full mb-8">
          <div className="rounded-lg p-4 w-full flex flex-col items-center">
            <div className="w-full flex items-center justify-between mb-4">
              ...
              <h2 className="text-2xl font-bold">LIFT QUESTIONS</h2>
