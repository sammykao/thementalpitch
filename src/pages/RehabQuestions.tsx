...
const RehabQuestions = () => {
  ...
  const [questions, setQuestions] = useState<Question[]>([
    { id: "1", text: "How do I feel about my rehab performance today?", enabled: true },
    { id: "2", text: "What did I do when I first woke up to set a positive tone for my recovery?", enabled: true },
    { id: "3", text: "Did I get 20 minutes of stretching in today? If not, why?", enabled: true },
    { id: "4", text: "How motivated was I before rehab today?", enabled: true },
    { id: "5", text: "After rehab, do I feel better or worse about my recovery process?", enabled: true },
    { id: "6", text: "What did/am I going to do to stay connected with my teammates today?", enabled: true },
  ]);
  ...
  const saveQuestions = () => {
    localStorage.setItem("rehabQuestions", JSON.stringify(questions));
    toast.success("Rehab questions saved!");
  };
        ...
        <div className="w-full mb-8">
          <div className="rounded-lg p-4 w-full flex flex-col items-center">
            <div className="w-full flex items-center justify-between mb-4">
              ...
              <h2 className="text-2xl font-bold">REHAB QUESTIONS</h2>
            ...
            <div className="w-full bg-[#193175] rounded-lg p-4 mb-6">
              <h3 className="text-center text-lg font-bold mb-4 bg-[#3056b7] py-1 rounded-lg">
                If injured, look through these questions and decide which questions look "worth answering" to you:
              </h3>
