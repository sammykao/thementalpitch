...
const RehabEntry: React.FC<RehabEntryProps> = ({ 
  entry, 
  isExpanded, 
  toggleExpanded,
  rehabQuestions
    ...
    return (
      <div className="space-y-3">
        {Object.entries(entry.content.answers).map(([questionId, answer]) => {
          ...
          const questionText = getQuestionTextById(questionId, "rehab", [], rehabQuestions, [], []);
